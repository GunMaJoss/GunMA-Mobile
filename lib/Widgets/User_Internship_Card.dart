...
import 'package:gunma/DetailPage/User_Internship_detail_screen.dart';
              ...
              children: [
                ...
                Text.rich(
                    TextSpan(
                      ...
                      children: [
                        TextSpan(
                    text: intern.duration.toString() + " Months", style: TextStyle(color: bDark, fontSize: 13, fontWeight: FontWeight.w600)
                        ),
                      ] 
                    ), 
                ),
